...
import com.example.asdf.Adapters.ChatAdapter;
import com.example.asdf.Model.ChatMessage;
import com.example.asdf.Model.User;
import com.example.asdf.Network.ApiService;
import com.example.asdf.R;
import com.example.asdf.databinding.ActivityChatBinding;
...
public class ChatActivity extends BaseActivity  {
    ...
    private void init(){
        ...
        preferenceManager = new com.example.asdf.utilities.PreferenceManager(this);
    ...
    private void sendMessage(){
        ...
        message.put(Constants.KEY_MESSAGE,binding.typeMessage.getText().toString());
        message.put(Constants.KEY_TIMESTAMP,new Date());
        database.collection(Constants.KEY_COLLECTION_CHAT).add(message);
        if (Conversionid != null){
            updateConversion(binding.typeMessage.getText().toString());
        }
        else {
            ...
            conversion.put(Constants.KEY_LAST_MESSAGE,binding.typeMessage.getText().toString());
        ...
        if (!isReceiverAvailable){
            try {
                ...
                data.put(Constants.KEY_MESSAGE,binding.typeMessage.getText().toString());
        ...
        binding.typeMessage.setText(null);
    }
 ...
 */
    ...
    private void checkForConversionRemotely(String senderId , String receiverId){
        database.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
                ...
                .get()
                .addOnCompleteListener(conversionCompleteListeners);
    }

    private final OnCompleteListener<QuerySnapshot> conversionCompleteListeners = task -> {
